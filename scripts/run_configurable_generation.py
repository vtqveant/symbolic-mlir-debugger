...
def main():
    ...
    print("1. python scripts/dap_trace_generation/configurable_arith_generator.py --config config/arith_ops_config.yaml")
    print("2. python scripts/dap_trace_generation/configurable_arith_generator.py --config config/arith_ops_config.yaml --mlir-only")
    print("3. python scripts/dap_trace_generation/configurable_arith_generator.py --config config/arith_ops_config.yaml --traces-only")
    print("4. python scripts/dap_trace_generation/configurable_arith_generator.py --config config/arith_ops_config.yaml --dry-run")
    print()
    ...
    print("  config/arith_ops_config.yaml          # Configuration")
    print("  config/arith_ops_documentation.md     # Documentation")
    print("  test_artifacts/mlir/arith/            # MLIR files")
    print("  generated_tests/arith_comprehensive/  # DAP traces")
    print("  manifest/arith_test_manifest.json     # Manifest")
    print("  docs/arith_test_coverage.md           # Coverage report")
    print("  docs/test_artifact_guide.md           # Usage guide")
    print()
    ...
    print("  python scripts/dap_trace_generation/configurable_arith_generator.py --config config/arith_ops_config.yaml")
