...
def create_basic_arith_test():
    ...
    test_script = {
        ...
        "program": str(
            Path(__file__).parent.parent / "debugger" / "fixtures" / "arith_basic_ops.mlir"
        ),
        "description": "Basic arithmetic operations test (add, sub, mul, div, rem)",
        "session": [
            {
                "command": "initialize",
                "arguments": {"adapterID": "mlir-debugger", "clientID": "test-arith-basic"},
                "expect": {"success": True},
            },
            {
            ...
            },
            {
                ...
                "arguments": {"expression": "a", "frameId": 0},
                "expect": {"success": True},
            },
            {
                "command": "symbolic/evaluate",
                "arguments": {"expression": "b", "frameId": 0},
                "expect": {"success": True},
            },
            {
                "command": "symbolic/explorePaths",
                "arguments": {"maxPaths": 1},
                "expect": {"success": True, "totalPaths": {"min": 1}},
            },
            {
                "command": "disconnect",
...
def create_conditional_arith_test():
    ...
    test_script = {
        ...
        "program": str(
            Path(__file__).parent.parent / "debugger" / "fixtures" / "arith_conditional.mlir"
        ),
        "description": "Conditional arithmetic operations test with branches",
        "session": [
            {
                "command": "initialize",
                "arguments": {"adapterID": "mlir-debugger", "clientID": "test-arith-conditional"},
                "expect": {"success": True},
            },
            {
                "command": "symbolic/setMode",
            ...
            },
            {
                ...
                "expect": {"success": True, "totalPaths": {"min": 3}},
            },
            {
                "command": "disconnect",
                "arguments": {"terminateDebuggee": True},
...
def create_edge_case_test():
    ...
    test_script = {
        ...
        "program": str(
            Path(__file__).parent.parent / "debugger" / "fixtures" / "arith_edge_cases.mlir"
        ),
        "description": "Edge case arithmetic operations test (division by zero, overflow)",
        "session": [
            {
                "command": "initialize",
                "arguments": {"adapterID": "mlir-debugger", "clientID": "test-arith-edge"},
                "expect": {"success": True},
            },
            {
                "command": "symbolic/setMode",
            ...
            },
            {
                ...
                "expect": {"success": True, "totalPaths": {"min": 2}},
            },
            {
                "command": "disconnect",
                "arguments": {"terminateDebuggee": True},
...
def create_mixed_bitwidth_test():
    ...
    test_script = {
        ...
        "program": str(
            Path(__file__).parent.parent / "debugger" / "fixtures" / "arith_mixed_bitwidth.mlir"
        ),
        "description": "Mixed bitwidth arithmetic operations test (i16, i32, i64)",
        "session": [
            {
                "command": "initialize",
                "arguments": {"adapterID": "mlir-debugger", "clientID": "test-arith-mixed"},
                "expect": {"success": True},
            },
            {
                "command": "symbolic/setMode",
            ...
            {
                "command": "symbolic/evaluate",
                "arguments": {"expression": "c", "frameId": 0},
                "expect": {"success": True},
            },
            {
                "command": "symbolic/explorePaths",
...
def create_existing_arith_test():
    ...
    test_script = {
        ...
        "program": str(
            Path(__file__).parent.parent / "debugger" / "fixtures" / "arithmetic_ops.mlir"
        ),
        "description": "Existing arithmetic operations test (sub, mul, div, add)",
        "session": [
            {
                "command": "initialize",
                "arguments": {"adapterID": "mlir-debugger", "clientID": "test-arithmetic-existing"},
                "expect": {"success": True},
            },
            {
                "command": "symbolic/setMode",
...
def create_z3_constraint_test():
    ...
    test_script = {
        ...
        "path_info": {"constraints": ["a > b", "a < b", "a == b"], "solver": "z3"},
        "session": [
            {
                "command": "initialize",
                "arguments": {"adapterID": "mlir-debugger", "clientID": "test-arith-z3"},
                "expect": {"success": True},
            },
            {
                "command": "symbolic/setMode",
            ...
            },
            {
                "command": "symbolic/explorePaths",
                "arguments": {"maxPaths": 3},
                "expect": {"success": True, "totalPaths": 3},
            },
            {
                "command": "disconnect",
                "arguments": {"terminateDebuggee": True},
...
def main():
    ...
    manifest = {
        "generated_tests": [
            {"file": Path(f).name, "path": f, "test_type": "arithmetic"} for f in saved_files
        ],
