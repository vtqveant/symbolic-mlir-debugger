...
class VisualizationGenerator:
    ...
    def create_execution_summary_chart(
        self, execution_metrics: Dict[str, Any], filename: str = "execution_summary.png"
    ) -> Path:
    ...
    def create_validation_summary_chart(
        self, validation_metrics: Dict[str, Any], filename: str = "validation_summary.png"
    ) -> Path:
    ...
    def create_generation_summary_chart(
        self, generation_metrics: Dict[str, Any], filename: str = "generation_summary.png"
    ) -> Path:
    ...
    def create_timeline_chart(
        self, execution_results: List[Dict[str, Any]], filename: str = "execution_timeline.png"
    ) -> Path:
    ...
    def create_error_distribution_chart(
        self, validation_metrics: Dict[str, Any], filename: str = "error_distribution.png"
    ) -> Path:
