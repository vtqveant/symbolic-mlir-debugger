...
class BaseGenerator(abc.ABC):
    ...
    def generate_all(self) -> Dict[str, Any]:
        ...
        self.stats["total_operations"] = sum(len(dialect.operations) 
                                           for dialect in self.config.dialects)
        ...
        logger.info(f"Generation complete: {self.stats['mlir_files_generated']} MLIR files, "
