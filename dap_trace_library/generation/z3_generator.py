...
class Z3Generator:
    ...
    def generate_for_constraint(self, constraint_expr: str, 
                               max_solutions: int = 3,
                               variable_bounds: Dict[str, tuple] = None) -> List[Dict[str, int]]:
        ...
        try:
            ...
            for var_name, z3_var in z3_vars.items():
                bounds = variable_bounds.get(var_name, default_bounds) if variable_bounds else default_bounds
    ...
    def _parse_constraint(self, constraint_expr: str, 
                         z3_vars: Dict[str, Any]) -> Optional[Any]:
