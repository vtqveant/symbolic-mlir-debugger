...
class ConfigUtils:
    ...
    def load_and_validate(path: Union[str, Path]) -> Dict[str, Any]:
        ...
        if not validation["valid"]:
            error_messages = [f"{error['path']}: {error['message']}" 
    ...
    @staticmethod
    def extract_dialect_config(config: Dict[str, Any], 
                              dialect_name: str) -> Optional[Dict[str, Any]]:
    ...
    @staticmethod
    def extract_operation_config(config: Dict[str, Any],
                               dialect_name: str,
    ...
    def generate_config_summary(config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "enabled_operations_by_dialect": {
                d["name"]: len([op for op in d.get("operations", []) 
