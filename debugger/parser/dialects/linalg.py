...
class LinalgIndexedGeneric(DialectOp):
    ...
    _opname_ = "linalg.indexed_generic"
...
class LinalgSlice(DialectOp):
    ...
    _syntax_ = (
        "linalg.slice {view_id.ssa_id} [ {indexing_ids.ssa_id_list} ]"
        " : {view_type.type} , {indexing_types.type_list_no_parens} "
        " , {result_type.type}"
    )
    _opname_ = "linalg.slice"
...
class TensorReshape(DialectOp):
    ...
    _opname_ = "linalg.tensor_reshape"
