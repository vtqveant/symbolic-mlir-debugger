...
def main():
    ...
    try:
        ...
        try:
            response = client.send_request("launch", {
                "program": "test_function.mlir",
                "noDebug": False
            })
            print(f"   Response: {response}")
        except Exception as e:
        ...
        try:
            response = client.send_request("setBreakpoints", {
                "source": {"path": "test_function.mlir"},
                "breakpoints": [{"line": 3}]
            })
            print(f"   Response: {response}")
        except Exception as e:
        ...
        try:
            response = client.send_request("continue", {
                "threadId": 1
            })
            print(f"   Response: {response}")
        except Exception as e:
