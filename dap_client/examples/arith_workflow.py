    ...
    try:
        ...
        with DAPClient() as client:
            ...
            result = client.initialize(
                ...
                client_id=f"{operation_type}-test-client"
            )
...
"""
    ...
    try:
        ...
        with DAPClient() as client:
            ...
            result = client.initialize(
                adapter_id="mlir-debugger",
                client_id="complex-arith-test-client"
            )
            print(f"   Initialized: {result}")
...
"""
    ...
    try:
        ...
        with DAPClient() as client:
            ...
            result = client.initialize(
                adapter_id="mlir-debugger",
                client_id="symbolic-arith-test-client"
            )
            print(f"   Initialized: {result}")
...
def main():
    ...
    parser.add_argument("--operation", choices=["add", "sub", "mul", "div", "rem", "cmp"],
                       help="Test specific arithmetic operation")
    parser.add_argument("--complex", action="store_true",
                       help="Test complex arithmetic expression")
    parser.add_argument("--symbolic", action="store_true",
                       help="Test symbolic arithmetic execution")
    parser.add_argument("--concolic", action="store_true",
                       help="Run concolic testing with parameter variation")
