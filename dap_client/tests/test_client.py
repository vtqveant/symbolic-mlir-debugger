...
from dap_client.core.connection import DAPConnectionError
...
class TestDAPClient:
    ...
    def test_set_breakpoints(self, client):
        ...
        client.session = DAPSession("localhost", 5678)
        client.session.set_breakpoints = MagicMock(return_value={
            "breakpoints": [
    ...
    def test_continue_execution(self, client):
        ...
        client.session = DAPSession("localhost", 5678)
        client.session.continue_execution = MagicMock(return_value={
